    ...
    <main className="container px-4 py-4">
      <div className="row">
        ...
        <article className="col-md-9">
          <h2 className="h2 text-success mb-4">Ареал поширення сурикатів</h2>
          ...
          <section id="subcontinents" className="mt-4">
            ...
            <div className="collapse" id="subcontinentsList">
              <ul className="list-group mb-3">
                <li className="list-group-item">Південна Африка</li>
              </ul>
            </div>
          </section>
          ...
          <section id="countries" className="mt-4">
            ...
            <div className="collapse" id="countriesList">
              <ul className="list-group mb-3 list-columns">
                <li className="list-group-item">ПАР (Південно-Африканська Республіка)</li>
                <li className="list-group-item">Ботсвана</li>
                <li className="list-group-item">Намібія</li>
                <li className="list-group-item">Ангола</li>
                <li className="list-group-item">Зімбабве</li>
                <li className="list-group-item">Мозамбік</li>
                <li className="list-group-item">Лесото</li>
                <li className="list-group-item">Свазіленд (Есватіні)</li>
              </ul>
            </div>
          </section>
          ...
          <section id="introduced" className="mt-4">
            ...
            <div className="collapse" id="introducedList">
              <ul className="list-group mb-3">
                <li className="list-group-item">Відомостей про інтродукцію сурикатів немає</li>
              </ul>
            </div>
          </section>
          ...
          <section id="biogeographic" className="mt-4">
            ...
            <div className="collapse" id="biogeographicList">
              <ul className="list-group mb-3">
                <li className="list-group-item">Ефіопська область</li>
              </ul>
            </div>
          </section>
          ...
          <section id="biomes" className="mt-4">
            ...
            <div className="collapse" id="biomesList">
              <ul className="list-group">
                ...
                <li className="list-group-item">Пустелі та напівпустелі</li>
              </ul>
            </div>
          </section>
        </article>
